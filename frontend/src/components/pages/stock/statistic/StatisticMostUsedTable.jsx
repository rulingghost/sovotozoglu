...
function StatisticMostUsedTable({ data, handleEdit, handleProjectDetail }) {
  ...
  const columns = [
    ...
    { key: 'UseRate', title: 'KULLANIM ORANI' },
  ]
  ...
  return (
    <CustomTable data={newData} columns={columns} title='AYIN EN ÇOK KULLANILAN ÜRÜNLERİ' />
    // <CustomTable data={newData} columns={columns} handleEdit={handleEdit} handleProjectDetail={handleProjectDetail} />
  )
}
export default StatisticMostUsedTable
