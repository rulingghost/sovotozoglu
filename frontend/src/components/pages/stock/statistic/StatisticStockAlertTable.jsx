...
function StatisticStockAlertTable({ data, handleEdit, handleProjectDetail }) {
  ...
  const columns = [
    ...
    { key: 'AmountOfStock', title: 'ÖNGÖRÜLEN STOK' },
    { key: 'LastPurchase', title: 'SON SATIN ALMA' },
    { key: 'AvailableStock', title: 'MEVCUT STOK' },
    { key: 'StockPercentage', title: 'STOK YÜZDESİ' },
  ]
